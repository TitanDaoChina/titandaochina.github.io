...
![img_17.png](/assets/img/hbase/img_17.png)

这里以 `RegionObservers ` 为例，其接口类中定义了所有可用的钩子方法，下面截取了部分方法的定义，多数方法都是成对出现的，有 `pre` 就有 `post`：

![img_18.png](/assets/img/hbase/img_18.png)

#### 4. 执行流程

![img_19.png](/assets/img/hbase/img_19.png)
...
![img_20.png](/assets/img/hbase/img_20.png)
...
![img_21.png](/assets/img/hbase/img_21.png)
...
![img_22.png](/assets/img/hbase/img_22.png)
...
![img_23.png](/assets/img/hbase/img_23.png)
...
![img_24.png](/assets/img/hbase/img_24.png)
