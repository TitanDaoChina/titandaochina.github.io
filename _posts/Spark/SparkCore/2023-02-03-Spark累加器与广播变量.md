...
![img_16.png](/../assets/img/sparkcore/img_16.png)
...
![img_17.png](/../assets/img/sparkcore/img_17.png)

### 2.2 使用累加器

`SparkContext` 中定义了所有创建累加器的方法，需要注意的是：被中横线划掉的累加器方法在 Spark 2.0.0 之后被标识为废弃。

![img_18.png](/../assets/img/sparkcore/img_18.png)
...
![img_19.png](/../assets/img/sparkcore/img_19.png)
